...
void ApplicationClustered<T>::recordDrawBuffer(FrameResource& res) {
  ...
  res.command_buffers.at("draw").copyImage(this->m_images.at("tonemapping_result").view(), vk::ImageLayout::eTransferSrcOptimal, *res.target_view, vk::ImageLayout::eTransferDstOptimal);
