...
void ApplicationVulkan::recordDrawBuffer(FrameResource& res) {
  ...
  vk::ImageBlit blit{};
  blit.srcSubresource = m_images.at("color_2").view().resourceLayers();
  ...
  res.command_buffers.at("draw")->blitImage(m_images.at("color_2").get(), m_images.at("color_2").view().layout(), m_swap_chain.image(res.image), m_swap_chain.layout(), {blit}, vk::Filter::eNearest);
