...
void ApplicationScenegraphClustered::createFramebufferAttachments() {
 auto depthFormat = findSupportedFormat(
  ...
  // light volume
  m_images["light_vol"] = BackedImage{m_device, lightVolExtent, vk::Format::eR32G32B32A32Uint, vk::ImageTiling::eOptimal, vk::ImageUsageFlagBits::eSampled | vk::ImageUsageFlagBits::eStorage};
